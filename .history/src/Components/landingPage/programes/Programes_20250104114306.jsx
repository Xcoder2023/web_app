        ...
        <div className="flex flex-col md:flex-row gap-8 w-full mx-auto items-center justify-center px-6 md:px-8 lg:px-24 my-8 md:my-20">
          {plans.map((plan, index) => (
            ...
            >
              ...
              <div className="absolute inset-0 bg-slate-800 bg-opacity-60 flex flex-col items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 text-white">
